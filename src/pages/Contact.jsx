...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Mail,
      label: "Email",
      value: "info@xyzassociates.com",
      href: "mailto:info@xyzassociates.com",
    },
    {
      icon: MessageCircle,
      label: "WhatsApp",
    ...
    },
    {
      icon: MapPin,
      label: "Office",
      value: "CG Road, Ahmedabad 380009",
              ...
              <div className="bg-white rounded-2xl border border-neutral-200 p-6 md:p-8 sticky top-28">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-neutral-500 text-sm">
                        301, Corporate Tower, CG Road, Ahmedabad 380009
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                ...
                <div className="mt-8 pt-6 border-t border-neutral-100">
                  ...
                  <div className="space-y-3">
                    <a
                      href="tel:+919876543210"
                      className="flex items-center gap-3 p-3 rounded-xl bg-neutral-100 hover:bg-neutral-200 transition-colors"
                    >
