      ...
      <section className="relative py-24 md:py-32 overflow-hidden min-h-[300px] sm:min-h-[360px]">
        ...
        <div className="container-custom relative z-10">
          <div className="max-w-2xl">
            <p className="text-sm font-semibold text-emerald-600 uppercase tracking-wider mb-4">About Us</p>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-neutral-900 leading-tight mb-6">
              Building trust through excellence
            </h1>
            <p className="text-lg text-neutral-800 leading-relaxed">
              Since 2005, we've been the trusted financial partner for businesses 
              across Gujarat, delivering expertise with integrity.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <h2 className="section-title">Two decades of financial excellence</h2>
              <div className="space-y-4 text-neutral-600 leading-relaxed">
                <p>
                  Shah & Associates was founded with a simple mission: provide exceptional 
                  financial services that truly make a difference.
                </p>
                <p>
                  Today, we serve over 5,000 clients across diverse industries, from 
            ...
            {/* Timeline */}
            <div className="bg-neutral-200/60 rounded-2xl p-8">
              <h3 className="font-semibold text-neutral-900 mb-8">Our Journey</h3>
              <div className="space-y-6">
                {milestones.map((item, index) => (
                  <div key={index} className="flex gap-4">
                    ...
                    <div className="pt-3">
                      <p className="text-sm text-emerald-600 font-medium">{item.year}</p>
      ...
      <section className="bg-neutral-100">
        <div className="container-custom">
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {[
              { icon: Target, title: 'Mission', text: 'Empower businesses with expert financial guidance, ensuring compliance and growth.' },
              { icon: Eye, title: 'Vision', text: 'Be the most trusted CA firm in Gujarat, known for excellence and innovation.' },
            ].map((item, index) => (
      ...
      <section className="section-padding bg-neutral-900 text-white">
        <div className="container-custom">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Recognized & Certified</h2>
          </div>
          <div className="flex flex-wrap justify-center gap-4">
            {['ICAI Member Firm', 'GST Suvidha Provider', 'ISO 9001:2015', 'DISA Certified'].map((cert, i) => (
              <div key={i} className="flex items-center gap-3 bg-neutral-800 px-5 py-3 rounded-full">
